        ...
        <div class="modal-content">
            ...
            <div class="modal-body text-center">
                <p class="px-5 pb-2">Are you sure you want to delete
                    Grade <?php echo $this->grade[Schema::GRADEDEFINITION_DISPLAY_CODE[Schema::COLUMN]]; ?>?<br/>
                ...
                <a class="btn btn-danger" aria-label="Delete"
                   href="/settings/grades/delete/<?php echo $this->grade[Schema::GRADE_ID[Schema::COLUMN]]; ?>">
                    Delete
                </a>
            </div>
