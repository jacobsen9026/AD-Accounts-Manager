    ...
    <table id="container">
        ...
        <tr>
            <td><br/><strong>Take Ownership</strong>
                ...
                <input style="max-width:50%" type="text" name="username"
                       autofocus><small>@<?php echo $appConfig["domainName"]; ?></small><br/>
            </td>
        </tr>
        <tr>
            <td>
                ...
                <br/><br/>
                <button onclick="showMessege('Granting technology staff read access to file please wait...')"
                        type="submit">Submit
                </button>
