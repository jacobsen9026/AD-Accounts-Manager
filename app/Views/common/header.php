...
//include("./app/includes/stylesheets.php");
        ...
        if (isset($_COOKIE["theme"])) {
            if ($_COOKIE["theme"] == "light") {
                echo '<link rel="stylesheet" type="text/css" href="/css/lightTheme.css">';
            } elseif ($_COOKIE["theme"] == "dark") {

                echo '<link rel="stylesheet" type="text/css" href="/css/darkTheme.css">';
            }
        } else {
            echo '<link rel="stylesheet" type="text/css" href="/css/lightTheme.css">';
        }
        if (isset($_SESSION["authenticated_tech"]) and $appConfig["debugMode"] and $_SESSION["authenticated_tech"]) {
            echo '<link rel="stylesheet" type="text/css" href="/css/sandbox.css">';
        }
        ?>
