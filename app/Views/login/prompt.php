...
if (isset($_SESSION)) {
    ...
    <input <?php if (!isset($_COOKIE["username"])) { ?>autofocus<?php } ?> type="text" name="username" value="<?php if (isset($_COOKIE["username"])) {
            echo $_COOKIE["username"];
        } ?>" autocomplet /><br/>
    Password
    <input <?php if (isset($_COOKIE["username"])) { ?>autofocus<?php } ?> type="password" name="password" value="<?php if (isset($_COOKIE["token"])) {
    ...
    <br /><div style="cursor:hand;" style="width:50%;height:3em;vertical-align:middle;display:inline">
        ...
        <input id="rememberUsernameCheckbox" style="cursor:hand;width:2em;vertical-align:middle;" type="checkbox" name="rememberUsername" <?php if (isset($_COOKIE["username"])) {
            echo 'checked=true';
        } ?>/>
<?php //print_r($_COOKIE); ?>
    </div>
    ...
    <div style="cursor:hand;" style="width:50%;height:3em;vertical-align:middle;display:inline">
        ...
        <input id="rememberMeCheckbox" style="cursor:hand;width:2em;vertical-align:middle;" type="checkbox" name="rememberMe" <?php if (isset($_COOKIE["token"])) {
    echo 'checked=true';
} ?>/>
    <?php //print_r($_COOKIE);?>
    </div><br/>
