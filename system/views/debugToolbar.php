...
if ((defined('DEBUG_MODE') and boolval(DEBUG_MODE) and ($this->core->logger != null)) or isset($this->appLogger)) {
    ...
    <div class='content'>
        ...
        ?> " data-toggle="modal" data-target="#logsModal">Logs
        </button>
                        ...
                        <ul class="sticky-top  nav nav-pills bg-primary row mx-0">
                            ...
                            if ($this->core->inDebugMode()) {
                                ...
                                <li class="nav-item col px-0">
                                    <a class="nav-link btn-primary active rounded-0 text-center " data-toggle="pill"
                                       href="#home">System</a>
                                </li>
                                <?php
                            }
                            if (!empty($this->core->app) and $this->core->app->inDebugMode()) {
                                ?>
                                <li class="nav-item col px-0">
                                    <a class="nav-link btn-primary rounded-0 text-center" data-toggle="pill"
                                       href="#menu1">App</a>
                                </li>
                                <?php
                            }
